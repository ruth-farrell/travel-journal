const travelJSONData = [
  ...
  },
  {
    ...
    slides: ["Valparaiso is covered top to bottom in the most amazing street art.", "valparaiso-door.jpeg",  "valparaiso-mask.jpeg", "valparaiso-sea-lion.jpeg", "valparaiso-mario.jpeg", "The town is extremely hilly and has historical funiculars (like cable cars) that take you up and down.", "valparaiso-funicular.jpeg","valparaiso-stairs.jpg", "valparaiso-lion.jpeg","The town also has many sets of stairs that are beautifully painted.", "valparaiso-steps-heels.jpeg", "valparaiso-stairs.jpeg"],
    tags: {homeCountry: false, currentLocation: false, travelHighlight: false},
  },
  {
    id: 51,
  ...
  },
  {
    ...
    slides: ["Easter Island/Rapa Nui is a 5 hour plane trip from Santiago, and is the most remote island in the world.", "easter-island-fifteen.jpeg", "easter-island-stones.jpeg", "easter-island-sunrise-fifteen.jpg", "The people are of polynesian descent and Kari Kari is the local dance culture.", "easter-island-dancing.jpeg",],
    tags: {homeCountry: false, currentLocation: false, travelHighlight: true},
  },
  {
    id: 53,
    ...
    slides: ["mendoza-city.jpeg", "mendoza-steak.jpeg"],
    tags: {homeCountry: false, currentLocation: false, travelHighlight: false},
  },
  {
    id: 54,
    ...
    slides: ["san-pedro-geysers.jpeg", "san-pedro-desert.jpeg"],
    tags: {homeCountry: false, currentLocation: false, travelHighlight: false},
  },
  {
    id: 55,
  ...
  },
  {
    ...
    imageUrl: "sucre.jpg",
    slides: ["sucre-footprint.jpeg", "sucre-many-footprints.jpeg"],
    tags: {homeCountry: false, currentLocation: false, travelHighlight: false},
  },
  {
    id: 57,
  ...
  },
  {
    ...
    slides: ["guatape-flowers.jpeg", "guatape-summer.jpeg", "guatape-umbrellas"],
    tags: {homeCountry: false, currentLocation: false, travelHighlight: false},
  },
  {
    id: 60,
    ...
    slides: ["medellin-pablo-escobar.jpeg", "medellin-football.jpeg"],
  ...
  },
  {
    ...
    slides: ["jardin-birds.jpeg", "jardin-waterfall.jpeg"],
  ...
  },
  {
    ...
    slides: ["amazon-rainbow.jpeg", "The journey to the Amazon, took an overnight bus, a 4 hour shuttle and 2 hour canoe trip", "amazon-beatle.jpeg", "amazon-caimon.jpeg", "amazon-sloth.jpeg", "amazon-stinky-turkey.jpeg"],
  ...
  },
  {
    ...
    slides: ["We visited the islands of San Cristobal, Isabella and Santa Cruz.","galapagos-penguin.jpeg","galapagos-sea-lion.jpeg", "galapagos-flamingo.jpeg",
    "galapagos-kicker-rock.jpeg", "galapagos-giant-tortoise.jpeg", "galapagos-booby.jpeg", "galapagos-sea-turtle.jpeg","galapagos-pelican.jpeg", "galapagos-marine-iguanas.jpeg", "galapagos-lake.jpeg"],
